...
// ✅ CORRECT for Vite: Use import.meta.env (NOT process.env)
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || 'https://exam-proctor-backend-jxrb.onrender.com';
const PYTHON_PROCTOR_URL = import.meta.env.VITE_PYTHON_PROCTOR_URL || 'https://exam-proctor-ai.onrender.com';

console.log('🔗 Backend URL:', BACKEND_URL);
console.log('🤖 Python Proctor URL:', PYTHON_PROCTOR_URL);
